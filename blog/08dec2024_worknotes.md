...
- Ring map settings
    ...
    - ползунок. Содержание в виде баланса между лбдом и силикатами
- Orbit Stations
    - Список спутников. можно добавить и удалить
    - параметры орбиты в виде рассояния. должны проходить только между кольцами, внутри или снаружи колец.
...
6. Виджет не умеет удалять кольцо из списка. Иными словами кнопка `-` не работает