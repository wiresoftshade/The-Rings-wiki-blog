...
- FarRing
    - сейчас материал его не передает все настраиваемые свойства колец в виде дальнего плана. Сейчс его вид примерный и не подчиняется данным, настроенным игроком в меню. Не видно лед/не лед, плотность просто из легаси текстуры в материале. минерализация тоже не отображается.
- Cluster
...
2. **INPROGRESS** Нет генерации параметров (плотность, состав минералов, баланс льда, оптические свойства) по текстуре, чтобы кольца имели красивый структурный вид по концепту. Это материалы, состав, количество вещества. Это про вид `FarRing`.
...
10. Кластеры занимаются лишней работой. Они расчитывают трансформации инстансов, которые могут быть посчитаны в BP_Ring. Мало того кластеры одинаковые в пределах трека и могут быть расчитаны в GameInstance предварительно как шаблон. 
