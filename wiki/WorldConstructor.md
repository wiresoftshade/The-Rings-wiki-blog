...
Оставшиеся проблемы переписаны сюда. Это список: 

- Game Instance
    - не умеет собирать с мира заготовленные кольца, газовый гигант, спутники, станции, окружение. (Сделать такой сборщик)
    - сделать кнопку, которая загрузит предустановленный уровень. у этого уровня настроить гейммод, который умеет собирать с него.
    - нужно решить на месте: 
        * только переключатель на гейммоде: Создавать сцену либо собирать все со сцены
        * позволить установить делать и то и другое. (?если нет данных создавать рандомные для генерации?)

- Ring
    - плотность создается из шаблонов, генерированных заранее (делается пулл актеров)
