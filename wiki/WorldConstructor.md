...
получается все сделано по объектам. Но оставшиеся проблемы нужно переписать сюда. Создать конкретный список. 
...
- Generator
    - рандомно выбирает текстуры 1 - для параметров кольца, 2 - для оптических свойств кольца. 
    - передает текстуры в свойства колец.

- Ring
    - собирать с текстур пиксели, интерпретировать/генерировать их, далее создать массивы свойств (минералы, лед, оптические св-ва). 
