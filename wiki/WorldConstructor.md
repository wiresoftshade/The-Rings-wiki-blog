# World Constructor. Система при помощи которой строится окружение вокруг планеты газового гиганта
...
7. Нет единого дата ассета для установок параметров мира и параметров ренерации колец, чтобы было удобно управлять.

8. Нет управления созданием сцен двух типов. а) полноценный мир сгенерированный по параметрам. в) предустановленный мир в виде левела заготовленного.
