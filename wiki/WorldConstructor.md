...
S_AsteroidProperty.uasset
S_BackAsteroidPhysics.uasset
S_Cluster.uasset
S_ClusterProperty.uasset
S_RingProperty.uasset
S_SpaceBodyProperties.uasset
S_SpaceBodyVariables.uasset
S_Track.uasset
S_WorldConstructorData.uasset

PDA_AsteroidField.uasset
PDA_Ring.uasset
PDA_SingleAsteroid.uasset
PDA_World.uasset

DA_Asteroid_Legacy.uasset
DA_Asteroid_MeteoriteD.uasset
DA_Field_Crystals.uasset
DA_Field_Ice.uasset
DA_Field_Silicates.uasset
DA_FirstWorld.uasset
DA_Ring_Mix.uasset
DA_Ring_Silicates.uasset
...
1. Нужно определить какие еще нужны параметры для создания колец. Нужно создать конкретный список. 
...
4. не понятно как формировать материал астероида.
