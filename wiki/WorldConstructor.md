...
3. Созданы структуры: `S_RingProperty`, `S_ClusterProperty`, `S_AsteroidProperty`.
    ...
    3.2 Нужно добавить необходимые данные в структуры по ходу решения других проблем (2, 5). 
...
10. ~~Не~~ поддерживает создание большой планеты в зависимости от заданного ее радиуса.

11. PolarWhite ~~не~~ умеет быть bigmass body. Она не улетает. тоит на месте.  